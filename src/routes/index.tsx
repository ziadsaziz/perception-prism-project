...
function Landing() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col px-6 pt-16 pb-10">
      ...
      <Link to="/auth" search={{ mode: "signup" }} className="group mt-8 relative overflow-hidden rounded-full px-6 py-4 bg-foreground text-background flex items-center justify-between glow-gold">
